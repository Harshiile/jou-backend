...
const getWorkSpaces = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    !(0, uuid_1.validate)(userId) && (0, ServerError_1.ServerError)(res, "UserId is not valid");
    if (typeof (userId) == 'string') {
        if (role == 'youtuber') {
            ...
            const workspaces = yield db_1.db.select({
                ...
                userHandle: schema_1.WorkspaceTable.userHandle,
                avatar: schema_1.WorkspaceTable.avatar,
            }).from(schema_1.WorkspaceTable).where((0, drizzle_orm_1.inArray)(schema_1.WorkspaceTable.id, subQuery));
            res.json({
